...
def rmse(datasets):
    ...
    for dataset in (datasets): 
        ...
        list[i]=rmse_stats
        i=i+1
#     path  = "C:\\Users\\Owner\\Desktop\\yujianzhong\\CODE OVER2\\RMSE_FCM\\train_data_1_RMSE.csv"
...
#         print("AUC_test:",AUC_test)
        ...
        list_AUC[i]=AUC
        i=i+1
    path  = "C:\\Users\\Owner\\Desktop\\yujianzhong\\CODE OVER2\\ACC_FCM\\train1_mean_median_imp_ACC_RF.csv"
    with open(path,'a+') as f:
        csv_write = csv.writer(f)
        data_row = list
        csv_write.writerow(data_row)
    path1  = "C:\\Users\\Owner\\Desktop\\yujianzhong\\CODE OVER2\\AUC_FCM\\train1_mean_median_imp_AUC_RF.csv"
    with open(path1,'a+') as f:
        csv_write = csv.writer(f)
        data_row = list_AUC
        csv_write.writerow(data_row)
...
#                      'min_samples_leaf':range(5,51,5)}
        ...
        list_AUC[i]=AUC
        i=i+1
    path  = "C:\\Users\\Owner\\Desktop\\yujianzhong\\CODE OVER2\\ACC_FCM\\train1_NOOS_ACC_RF.csv"
    with open(path,'a+') as f:
        csv_write = csv.writer(f)
        data_row = list
        csv_write.writerow(data_row)
    path1  = "C:\\Users\\Owner\\Desktop\\yujianzhong\\CODE OVER2\\AUC_FCM\\train1_NOOS_AUC_RF.csv"
    with open(path1,'a+') as f:
        csv_write = csv.writer(f)
        data_row = list_AUC
        csv_write.writerow(data_row)
...
get_ipython().run_line_magic('autosave', '10  # 每 10 秒自动保存')
